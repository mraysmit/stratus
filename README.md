...
The current executable module is the [storage contract verifier](verification/storage-contract/). The corresponding Docker/Podman environment is the [Ceph developer harness](platform/ceph/local/).
