...
Create `platform/keycloak/image/Containerfile`:
...
| `P1-7.1-D1` | `P1-7.1` | Developer | Deploy disposable FreeIPA/CA and Keycloak integration used to prove clients and migration automation. | Security owner | `P1-7.1-S1` | `platform/freeipa/developer/`; `platform/keycloak/developer/` | lifecycle, user/service/token/cert smoke | developer gate | Platform owner | Local DNS/time | Not started |
| `P1-7.1-P1` | `P1-7.1` | Production | Deploy replicated FreeIPA/Dogtag with backup, restore, monitoring, and service identities. | Security/operations owners | `P1-7.1-D1` | `platform/freeipa/`; `environments/production/freeipa/`; runbooks | replica loss, CA issuance, backup/restore | P1-P7 | Security owner | DNS/NTP/CA outage risk | Not started |
| `P1-7.2-P1` | `P1-7.2` | Production | Deploy redundant Keycloak and external PostgreSQL, federation, realm, clients, HA/cache posture, backup and restore. | Security owner | `P1-7.1-P1` | `platform/keycloak/`; `environments/production/keycloak/`; realm exports | failover, token claims, DB restore | P4-P10 | Operations owner | Database/cache design | Not started |
...
| `P1-7.6-R1` | `P1-7.6` | Production | Execute integrated identity outage, token/key/cert expiry, restore, alert, and break-glass drills. | Operations/security owners | `P1-7.5-P1` | `operations/failure-drills/identity/` | RTO/RPO, alerts, audit, defects/reruns | P29-P33 | Operations owner | Maintenance window | Not started |
