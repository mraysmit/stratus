...
| P1-2.5 | Metadata-driven maintenance verification | Data platform owner | P1-2.4 | Metadata table queries and threshold-based maintenance decisions for files, snapshots, manifests, delete files, and orphan files | Data engineering owner | Not started - snapshot expiry is covered by `P1-2.4-V1`; compaction, manifest, delete-file, and orphan-file decisions remain (`P1-2.5-D1`) |
