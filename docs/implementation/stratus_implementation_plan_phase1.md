...
| P1-4.1 | Airflow platform deployment | Operations owner | P1-3 accepted | Airflow services and PostgreSQL metadata database healthy; DAG directory/version recorded | Platform owner | In progress - shared Airflow 3.3.1 image accepted for developer use on 2026-08-17 under `WAIVER-P1-4.1-S1-20260817`, expiring 2026-09-16 with production promotion prohibited; developer deployment has not started |
