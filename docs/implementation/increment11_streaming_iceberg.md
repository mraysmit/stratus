...
| `P2-11.R1` | Production | Execute replay/rebuild, checkpoint loss, partial commit, catalog/object outage, rollback, and reconciliation drills. | Operations/data owners | `P2-11.P2` | `operations/runbooks/streaming-iceberg/` | timed drills, row/snapshot reconciliation | P12-P17 | Platform owner | Destructive replay | Not started |
