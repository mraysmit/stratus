...
- Main architecture: [stratus_on_prem_data_fabric_architecture.md](../architecture/stratus_on_prem_data_fabric_architecture.md)
- Phase 1 implementation plan: [stratus_implementation_plan_phase1.md](../implementation/stratus_implementation_plan_phase1.md)
- Increment 1 - Ceph RGW: [increment1_ceph.md](../implementation/increment1_ceph.md)
- Increment 2 - Iceberg and Polaris: [increment2_iceberg_polaris.md](../implementation/increment2_iceberg_polaris.md)
- Increment 3 - Spark: [increment3_spark.md](../implementation/increment3_spark.md)
- Increment 4 - Airflow: [increment4_airflow.md](../implementation/increment4_airflow.md)
- Increment 5 - Trino: [increment5_trino.md](../implementation/increment5_trino.md)
- Increment 6 - Atlas and Ranger: [increment6_atlas_ranger.md](../implementation/increment6_atlas_ranger.md)
- Increment 7 - Identity and Security: [increment7_identity_security.md](../implementation/increment7_identity_security.md)
