...
| [`decisions/`](decisions/) | Accepted architecture decision records, named `ADR-P<phase>-NNN-short-title.md`. Currently [ADR-P1-001](decisions/ADR-P1-001-ceph-baseline.md), which selects Ceph RGW as the Phase 1 storage baseline, [ADR-P1-002](decisions/ADR-P1-002-single-bash-harness-scripts.md), which adopts a single bash implementation for the harness scripts, [ADR-P1-003](decisions/ADR-P1-003-composed-harness-internal-dns.md), which attaches composed product harnesses over internal DNS, and [ADR-P1-004](decisions/ADR-P1-004-openbao-secret-distribution.md), which adopts OpenBao for pull-based platform secret distribution. |
