...
load_environment
: "${CEPH_RGW_ACCESS_KEY:?CEPH_RGW_ACCESS_KEY is empty in .env. Copy CEPH_SVC_POLARIS_ACCESS_KEY from platform/ceph/compose-cluster/.env (generated by ceph-compose-provision-service-identities.sh)}"
: "${CEPH_RGW_SECRET_KEY:?CEPH_RGW_SECRET_KEY is empty in .env. Copy CEPH_SVC_POLARIS_SECRET_KEY from platform/ceph/compose-cluster/.env}"
