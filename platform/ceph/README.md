...
```text
ceph/
├── tests/             # shared Ceph/RGW contracts and implementation guardrails
...
`CephRgwContractTest` runs the same live S3, security, consistency, pagination,
and multipart contract against any Ceph RGW endpoint supplied through
